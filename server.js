...
app.get('/get-product/:productId', async (req, res) => {
  ...
  const url = `https://${storeDomain}/admin/api/2024-07/products/${productId}.json`;
...
app.get('/list-products', async (req, res) => {
  ...
  const url = `https://${storeDomain}/admin/api/2024-07/products.json?limit=50`;
...
app.post('/create-variant', async (req, res) => {
  ...
  const url = `https://${storeDomain}/admin/api/2024-07/products/${productId}/variants.json`;
